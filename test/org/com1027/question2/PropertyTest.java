...
public class PropertyTest {
	...
	@Test
	public void testDisplayOccupiedProperties()  {
		Room room1 = new Room(900);
		Room room2 = new Room(1000);
		...
		Property house = new House(1, "The Chase", "Guildford", "GU2 7UB", 3);

		house.occupyRoom(room1, tenant1);
		house.occupyRoom(room2, tenant2);

		assertEquals("1 The Chase, Guildford GU2 7UB (3 bedroom house :1 available)\n" + 
				"\tRoom:  900.0\n" + "\tRoom:  1000.0\n" + "\tTotal: £22800.00" , house.displayOccupiedProperties());
	}
